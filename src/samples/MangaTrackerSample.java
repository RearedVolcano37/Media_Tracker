...
public class MangaTrackerSample {
        ...
        public static void main(String[] args) {
                ...
                tracker.addSeries("The Beginning After The End",
                ...
                tracker.setStatus("The Beginning After The End",
                                Status.PLANNING);
                ...
                System.out.println("Manga: "
                                + tracker.countByType(MediaType.MANGA));
                System.out.println("Webtoons: "
                                + tracker.countByType(MediaType.WEBTOON));
                System.out.println("Light Novels: "
                                + tracker.countByType(MediaType.LIGHTNOVEL));
                System.out.println("In Progress: "
                                + tracker.countByStatus(Status.IN_PROGRESS));
                System.out.println("Completed: "
                                + tracker.countByStatus(Status.COMPLETED));
                System.out.println("Planning: "
                                + tracker.countByStatus(Status.PLANNING));
