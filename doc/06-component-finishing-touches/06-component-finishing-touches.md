...
Completing the portfolio project made software development feel much more real. Designing an API, implementing a kernel/secondary component stack, writing tests, and publishing a repo all showed me how much of development is about making a product that works for others.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

Yes, this project exposed gaps in my understanding of package organization, interface design, and test-driven development. I addressed them by refactoring the component structure to match the OSU pattern, writing a dedicated test suite, and using git to track changes and cleanly publish the work.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

My perspective has become more positive. I still enjoy software development because the process of building something from scratch, then testing and polishing it, feels rewarding and practical.
...
The skills I picked up include structured component design, enum-based API modeling, writing and running tests, documentating software, managing source control, and preparing example applications.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

- Designed and implemented a reusable Java component using OSU-style kernel and secondary interfaces.
- Developed a comprehensive test suite to verify component behavior and edge cases.
- Published and documented a GitHub project with sample applications and a polished README.
- Used version control and repository management to track changes and deploy final work.

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

This project made me more interested in software engineering. It showed me that I can build complete components, document them, and publish real work, which makes the field feel more meaningful.
...
To continue on this path, I can keep building small reusable components, learn CI/CD workflows, and contribute to open source projects. I can also reach out to course instructors, teaching assistants, experienced classmates, or GitHub community members for feedback and mentorship.
